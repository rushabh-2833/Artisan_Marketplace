            ...
            <form action="register.php" method="POST" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <div id="password-strength" class="mt-2">
                        ...
                        <div id="strength-text" class="mt-1">Weak</div>
                    </div>
                </div>
                ...
                <div class="text-center mt-3">
                    <p>Already have an account? <a href="login.php" class="text-primary fw-bold">Log in now</a>.</p>
                </div>
            </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            passwordInput.addEventListener('input', function() {
                ...
                strengthFill.style.width = `${(strengthLevel + 1) * 33.33}%`; // 33.33% for Weak, 66.66% for Normal, 100% for Strong
