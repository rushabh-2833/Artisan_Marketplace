...
$total_notifications_query = "SELECT COUNT(*) AS total_notifications FROM notifications WHERE user_id = ?";
...
$sql = "SELECT id, message, created_at, is_read FROM notifications WHERE user_id = ? ORDER BY created_at DESC LIMIT ? OFFSET ?";
...
$update_read_query = "UPDATE notifications SET is_read = 1 WHERE user_id = ? AND is_read = 0";
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <?php
                    // Fetch notifications with product details and status
                    $sql = "
                        SELECT n.id AS notification_id, n.message, n.created_at, n.is_read,
                    ...
                    if ($result->num_rows > 0): ?>
                        <?php while ($notification = $result->fetch_assoc()): ?>
                            <div class="notification-item">
                                <img src="<?php echo htmlspecialchars($notification['image_url']); ?>" alt="Product Image" class="notification-image">
                                <div class="notification-details">
                                    <p class="product-title"><?php echo htmlspecialchars($notification['product_name']); ?></p>
